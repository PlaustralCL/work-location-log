...
class TestDatabase(unittest.TestCase):
    ...
    def test_get_year_average(self):
        self.assertAlmostEqual(2.78,self.db.get_ytd_average(year=2024, end_week="2024-52"),delta=.01)
        self.assertAlmostEqual(.15, self.db.get_ytd_average(year=2023, end_week="2023-52"), delta=.01)
